...
if (isset($_REQUEST["act"]) && $_REQUEST["act"] == "save" && $marca != "") {
    try {
        ...
        if ($stmt->execute()) {
            if ($stmt->rowCount() > 0) {
                echo "<p class=\"bg-success\">Dados atualizado com sucesso!</p>";
                $id = null;
                $marca = null;
                $modelo = null;
                $cor = null;
                ...
                echo "<p class=\"bg-danger\">Erro ao tentar atualizar</p>";
            }
        } else {
                            ...
                            <div class="panel-footer">
                                <div class="clearfix">
                                    <div class="pull-right">
                                        <button type="submit" class="btn btn-primary" /><span class="glyphicon glyphicon-ok"></span> atualiza</button>
                                    </div>
                                </div>
                            </div>
                        </div>
